document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("brincos2").addEventListener("click", function() {
        console.log("Botão clicado");
        popup.style.display = "flex";
    });

    document.getElementById("comprarAgora6").addEventListener("click", function() {
        window.location.href = "https://wa.me/+5511972772655";
    });

    document.getElementById("fecharPopup6").addEventListener("click", function() {
